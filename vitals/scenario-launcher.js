(() => {
  ...
  const cases = [
    { id:'asthma', image:'/vitals/assets/scenario-asthma-learning.svg', title:'Respiratory Distress', patient:'24-year-old adult', scene:'Apartment • inhaler nearby', clue:'Upright, anxious, short sentences', dispatch:'You are dispatched for a 24-year-old with worsening shortness of breath and wheezing.', goal:'Judge respiratory severity, discover the trigger and medication history, treat, and prove response with reassessment' },
    { id:'stroke', image:'/vitals/assets/scenario-stroke-learning.svg', title:'Possible Acute Stroke', patient:'68-year-old adult', scene:'Private residence • family present', clue:'Abnormal speech and right-sided weakness', dispatch:'You are dispatched for a 68-year-old with sudden speech difficulty and right-sided weakness.', goal:'Establish last-known-well, exclude a reversible mimic, document deficits, and prioritize stroke-system transport' },
    { id:'hypoglycemia', image:'/vitals/assets/scenario-hypoglycemia-learning.svg', title:'Altered Mental Status', patient:'57-year-old adult', scene:'Workplace break room', clue:'Confused, diaphoretic, slow to follow commands', dispatch:'You are dispatched for a 57-year-old who is confused, sweaty, and behaving abnormally.', goal:'Find a reversible cause, match treatment to airway and swallowing safety, and prove recovery with reassessment' },
