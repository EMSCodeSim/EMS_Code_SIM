...
function click(){tone(760,.035,.09,'square')}
function beep(){tone(920,.09,.16,'sine')}
function pulse(){tone(90,.05,.18,'sine');try{navigator.vibrate?.(25)}catch(_){}}
function playBreath(kind='normal',volume=1){
