(() => {
  ...
  const PROFILES = {
    ...
    horse_crush: {
      ...
      questions:[
        {id:'name',category:'identity',label:'Patient name',prompt:'What is your full name?',response:'“Janet Miller. You can call me Janet.”',keywords:['name','full name','who are you','identify']},
        {id:'dob',category:'identity',label:'Date of birth',prompt:'What is your date of birth?',response:'“April 12, 1962.”',keywords:['date of birth','dob','birthday','born']},
        {id:'age',category:'identity',label:'Patient age',prompt:'How old are you?',response:'“I am 64.”',keywords:['age','how old']},
        {id:'address',category:'identity',label:'Home address',prompt:'What is your home address?',response:'“I live here on the horse property. This is my home address.”',keywords:['address','home','where do you live']},
        {id:'emergency_contact',category:'identity',label:'Emergency contact',prompt:'Is there someone you want us to contact?',response:'“My husband, Paul, is nearby at the barn.”',keywords:['emergency contact','contact','husband','family','call someone']},
