(() => {
  ...
  function saveHorseHospitalHandoff() {
    ...
    refreshFromRecord({ force:true });
    renderHorseHospitalHandoff();
    sceneObservationUpdate = { id:`horse-handoff-saved-${Date.now()}`, type:'HANDOFF COMPLETE', title:'Report given', text:'Hospital handoff saved. The receiving team has your report and care can transfer.', kind:'transport', sticky:true, recordedAt:new Date().toISOString() };
    lastInfoSignature = '';
    renderInfoUpdate(true);
