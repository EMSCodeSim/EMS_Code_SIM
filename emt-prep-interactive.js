...
const modules={
  ...
  'vital-signs':()=>renderCircuit(currentRoot,'vital-signs',{title:'Complete the vital-sign simulator circuit',minutes:'40–50',intro:'Use the matching simulator immediately after each lesson topic. Complete the task, record one result, and mark the station finished.',stations:[{title:'Manual blood pressure',href:'/vitals/bp.html',task:'Complete at least two readings and identify the systolic and diastolic values.',record:'Record one BP result',placeholder:'Example: 118/76 mmHg'},{title:'Pulse assessment',href:'/vitals/pulse.html',task:'Count a simulated pulse and describe rate and rhythm.',record:'Record rate and rhythm',placeholder:'Example: 84, regular'},{title:'Respiratory rate',href:'/vitals/respiratory-rate.html',task:'Count chest rises and document rate, depth, and effort.',record:'Record respiratory finding',placeholder:'Example: 20, normal depth, unlabored'},{title:'Breath sounds',href:'/vitals/breath-sound-simulator.html',task:'Compare at least three breath sounds and identify the assessment location.',record:'Record one sound and location',placeholder:'Example: wheeze, bilateral fields'},{title:'Pulse oximetry',href:'/vitals/pulse-ox.html',task:'Review a reading and identify at least one factor that could make it unreliable.',record:'Reading plus limitation',placeholder:'Example: 94%; motion can affect it'},{title:'Skin signs',href:'/vitals/skin.html',task:'Identify color, temperature, and moisture instead of writing only “normal.”',record:'Record skin finding',placeholder:'Example: pale, cool, clammy'},{title:'Blood glucose',href:'/vitals/bgl.html',task:'Complete a glucose scenario and connect the number to the patient presentation.',record:'Record glucose and context',placeholder:'Example: 54 mg/dL with confusion'},{title:'Pupil assessment',href:'/vitals/pupil.html',task:'Compare pupil size and reactivity, then describe the finding objectively.',record:'Record pupil finding',placeholder:'Example: equal, round, reactive'},{title:'Temperature',href:'/vitals/temperature.html',task:'Interpret a reading and document the value, units, route, and context.',record:'Record temperature finding',placeholder:'Example: 101.6°F oral, elevated'}],success:'Vital-sign circuit complete. You practiced each finding with its matching simulator and recorded objective results rather than only memorizing ranges.'}),
